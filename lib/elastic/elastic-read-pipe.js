...
//init the ElasticReadPipe, get the searchParam
function ElasticReadPipe(elasticConfigOrClient, indices, type, query)
{
...
util.inherits(ElasticReadPipe, Readable);

ElasticReadPipe.prototype._read = function readElastic() {
  var self = this;
...
module.exports = ElasticReadPipe;
